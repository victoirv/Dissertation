...
\begin{figure}[htp!]
	\centering
	\includegraphics[width=0.7\linewidth]{Figures/StormAvs/stormavs-dd12-GOES6}
...
\begin{figure}[htp!]
	\centering
	\includegraphics[width=0.7\linewidth]{Figures/StormAvs/stormavs-mass-gt20-GOES6}
...
\begin{figure}[htp!]
	...
	\caption{\req\ and \dst\ of events binned by median \f\ values. \vinote{Temerin and Li \dst\ model. Bz seems to have little impact. }}
...
\vinote{Moldwin 2014 long duration southward IMF Bz 10.1002/2013JA018937}
...
\begin{figure}[htp!]
	...
	\caption{\dst\ predicted by nonlinear model of day of year. Bottom: Same, but including a dimension for $B_z$. \vinote{See/improve DoYDst figure}}
	\label{fig:DoYDst}
\end{figure}

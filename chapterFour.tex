...
It can be seen that $F_{10.7}$ almost always correlates the best with \req, but that there is significant variance between data from different satellites. \inote{Need more discussion about tables. Add section about ARX results between linear and nonlinear}
...
\begin{figure}[htp!]
	...
	\caption{Top: \dst\ predicted by nonlinear model of day of year. Bottom: Same, but including a dimension for $B_z$. \vinote{See/improve DoYDst figure}}
	\label{fig:DoYDst}
\end{figure}

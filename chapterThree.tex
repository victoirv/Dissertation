...
\begin{figure}[htp!]
	...
	\caption{Data from GOES 6 with dashed lines indicating default storm thresholds \vinote{Try using lines for all blue plots}}
	\label{fig:alldata-GOES6-1983-1991}
\end{figure}
\begin{figure}[htp!]
	\centering
	\includegraphics[width=1\linewidth]{Figures/alldata-GOES6-1989-1989}
	\caption{Data from GOES 6 around March 1989 geomagnetic storm \inote{Find two more events like this and make similar plots}}

...
\begin{figure}[htp!]
	...
	\caption{Relative position of plasmasphere (blue) and radiation belts (red) with varying geomagnetic activity levels \cite{LinksBetweenPlasmapauseRadiationBeltFig}.}
